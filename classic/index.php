                ...
                <div class="col-xs-12">
                    <div class="navbar-header smoth">
                        <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#mainmenu">
                            ...
                            <a class="navbar-brand" href="#home-area"><h2 style="color: white"><img src="images/hand.png" style="padding-bottom: 15px" alt="">AASHRAY</h2></a>
                    </div>
                    <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                        <ul class="nav navbar-nav navbar-right help-menu">
                            
                            <li><a href="../login/index.php"><i class="icofont icofont-user-alt-4"></i><strong>  Login</strong></a></li>
                            <li><a href="../login/signup.php"><i class="icofont icofont-user-alt-4"></i><strong> Sign Up </strong></a></li>
...
<!--                            <li class="active"><a href="colorlib-regform-7/signup.html">Career</a></li>-->
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-10 col-md-8">
                        <div class="header-text">
                            <h2 class="header-title wow fadeInUp">Providing a helping hand for people in need.</h2>
<!--
                            <div class="wow fadeInUp" data-wow-delay="0.5s"><q>Select your location and we take care of the rest</q></div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-5">
                    <div class="page-title">
                        <h2 class="title wow fadeInUp">We bring ESIC worker's Healthcare closer than ever</h2>
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <p>The gap between Factories and ESIC Hospitals will finally be bridged with the help of AASHRAY</p>
                        </div>
                    </div>
                ...
                <div class="hidden-xs col-sm-6 col-md-offset-1">
                    <img src="images/about-image.png" alt="designOfSystem">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="page-title text-center">
                        ...
                        <p>Here's how the working of AASHRAY takes place:</p>
                    </div>
                </div>
            </div>
            <div class="row process text-center">
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-process">
                        ...
                        <p>Select your appropriate credentials</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-process">
                        ...
                        <p>Everything made easy with a simple click of button</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-process">
                        ...
                        <h3>Time to relax</h3>
                        <p>The automated system will check into the problem</p>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="single-process">
                        ...
                        <h3>Healthcare</h3>
                        <p>Better healthcare for workers with AASHRAY</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
                    <div class="page-title text-center">
                        ...
                        <p>AASHRAY's features are as follows:</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4>Virtual Doctor</h4>
                        <p>AASHRAY presents a completely virtual doctor that analyses your symptoms.</p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <h4>Date Predictor</h4>
                        <p>Predicts the next arrival date for doctors based on the patients medical history.</p>
                        <a href="#" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="0.6s">
                        ...
                        <h4>Medicine Repository</h4>
                        <p>Automates the medicine management process.</p>
                        <a href="#" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="1.2s">
                        ...
                        <p>Shows the time frame of availability of beds in the Hospital</p>
                        <a href="#" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="1s">
                        ...
                        <h4>NGO</h4>
                        <p>Gives an option for NGO's to collaborate with AASHRAY.</p>
                        <a href="#" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="0.8s">
                        ...
                        <h4>Smart Maps</h4>
                        <p>Maps shows the nearest ESIC Hospitals in a given location .</p>
                        <a href="#" class="read-more">Read More</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-form">
                            <form action="process.php" id="contact-form" method="post">
                                <div class="form-double">
                                    <input type="number" id="form-name" name="form-name" placeholder="Full Name" required="required">
